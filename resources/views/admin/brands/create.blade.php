...
<div style="max-width:1100px;margin:0 auto">
      <h1 style="margin:0 0 16px 0;font-size:22px;font-weight:800;color:#111827;">Agregar nueva marca</h1>
  ...
  <div style="border:1px solid #e5e7eb;border-radius:14px;background:#ffffff;box-shadow:0 1px 3px rgba(0,0,0,.06),0 1px 2px rgba(0,0,0,.03);">
    <div style="padding:18px 18px 0 18px;">
      @if($errors->any())
        <div role="alert"
          ...
          <button type="button" data-bs-dismiss="alert" aria-label="Cerrar"
    ...
    <div style="padding:0 18px 18px 18px;">
      <form action="{{ route('admin.brands.store') }}" method="post" id="brandForm">
        ...
        <!-- Botón submit (verde consistente) -->
        <button
          type="submit"
          name="Save"
          id="submitBtn"
